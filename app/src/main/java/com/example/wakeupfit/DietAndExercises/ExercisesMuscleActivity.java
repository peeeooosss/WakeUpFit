...
public class ExercisesMuscleActivity extends AppCompatActivity {
    ...
    private void playVideo() {
        ...
        String videoPath1 = "android.resource://" + getPackageName() + "/" + R.raw.latpull;
        String videoPath2 = "android.resource://" + getPackageName() + "/" + R.raw.burbelcurl;
        String videoPath3= "android.resource://" + getPackageName() + "/" + R.raw.legpush;
        String videoPath4 = "android.resource://" + getPackageName() + "/" + R.raw.romandead;
        String videoPath5 = "android.resource://" + getPackageName() + "/" + R.raw.dips;
        String videoPath6 = "android.resource://" + getPackageName() + "/" + R.raw.dumbellpress;
