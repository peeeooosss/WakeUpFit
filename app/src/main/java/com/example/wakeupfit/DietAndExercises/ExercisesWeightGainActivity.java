...
public class ExercisesWeightGainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_weight_gain);
    ...
    private void playVideo() {
        ...
        String videoPath1 = "android.resource://" + getPackageName() + "/" + R.raw.dumbellpress;
        String videoPath2 = "android.resource://" + getPackageName() + "/" + R.raw.legpush;
        String videoPath3= "android.resource://" + getPackageName() + "/" + R.raw.seatedcablerows;
        String videoPath4 = "android.resource://" + getPackageName() + "/" + R.raw.tricepsextension;
        String videoPath5 = "android.resource://" + getPackageName() + "/" + R.raw.squats;
        String videoPath6 = "android.resource://" + getPackageName() + "/" + R.raw.lunges;
        String videoPath7 = "android.resource://" + getPackageName() + "/" + R.raw.overheadpress;
